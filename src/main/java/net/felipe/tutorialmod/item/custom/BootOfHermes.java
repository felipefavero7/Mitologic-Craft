...
public class BootOfHermes extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.RUBY, new StatusEffectInstance(StatusEffects.SPEED, 400, 8))
                    .build();

    public BootOfHermes(ArmorMaterial material, Type type, Settings settings) {
