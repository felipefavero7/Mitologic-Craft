...
public class HelmetOfPoseidon extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ModArmorMaterials.RUBY, new StatusEffectInstance(StatusEffects.WATER_BREATHING, 400, 8))
                    .build();

    public HelmetOfPoseidon(ArmorMaterial material, Type type, Settings settings) {
